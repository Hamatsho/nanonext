...
const Form = () => {
    ...
    const inputs = fields.map((f, i) => {
        ...
        switch (f.field_type.code) {
            ...
            case "state_select":
                {
                    ...
                    return (
                        <CountrySelect key={"country"} handle={handleChange} />
                    );
                }
                break;
            case "radio_list":
                return (
                    <RadioList key={f.id} field={f} onChange={handleChange} />
                );
                break;
            case "file_uploader":
                return (
            ...
            case "checkbox":
                return (
                    <Checkbox key={f.id} field={f} onChange={handleChange} />
                );
            case "checkbox_list":
                return (
                    <CheckboxList
            ...
            case "color_picker":
                return (
                    <ColorPicker key={f.id} field={f} onChange={handleChange} />
                );
                break;
            ...
            case "nano_captcha":
                return (
                    <NanoCaptcha key={f.id} field={f} onChange={handleChange} />
                );
                break;
        }
